...
class DocumentStoreOne
{
        ...
        switch ($strategy) {
            ...
            case self::DSO_REDIS:
                ...
                if (function_exists('cache')) {
                    ...
                    if (!$r) {
                        $this->throwError('Redis is not open');
                        return;
                    }
                }
                break;
    ...
    public function insert($id, $document, $tries = -1)
    {
        ...
        if ($this->lock($file, $tries)) {
            if(!isset($document[0]) && $this->tabular) {
                ...
                $errorLast=@error_get_last()['message'];
            } else {
                $write = false;
    ...
    public function createCollection($collection)
    {
        ...
        if($r===false) {
            $this->throwError('error create collection :'.@error_get_last()['message']);
        }
