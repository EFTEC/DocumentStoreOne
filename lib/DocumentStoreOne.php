...
class DocumentStoreOne
{
     ...
     * @return void
     */
    public function deleteCollection(string $collection, bool $throwOnError = false): void
    {
        $oldCollection = $this->collection;
        $this->collection = $collection;
     ...
     * @return void
     */
    public function regionalStyle(string $regionalDecimal = '.', string $regionalDate = 'Y-m-d', string $regionalDateTime = 'Y-m-d H:i:s'): void
    {
     ...
     * @return array|false
     */
    public function select(string $mask = "*", bool $returnOnlyIndex = true)
    {
