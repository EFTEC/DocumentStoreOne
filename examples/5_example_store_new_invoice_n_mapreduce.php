...
$flatcon->schema("invoices")->insertOrUpdate($numInv,json_encode($inv)); // store a new invoice

$mapReduceCustomers=$flatcon->schema("invoicemap")->get("invoicexcustomer"); // get the map reduce.
...
$flatcon->schema("invoicemap")->insertOrUpdate("invoicexcustomer",json_encode($mapReduceCustomers)); // we store back the map reduce.
